      ...
      <DrawerPrimitive.Portal>
        ...
        >
          ...
          <div className="flex min-h-0 flex-1 flex-col gap-4 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4 sm:px-6 sm:pb-6">
            <div className="relative min-h-0 flex-1 overflow-hidden rounded-[1.75rem] border border-white/10 bg-[linear-gradient(180deg,rgba(9,14,29,0.88),rgba(4,7,18,0.96))] shadow-[inset_0_0_20px_rgba(139,92,246,0.12)]">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(139,92,246,0.2),transparent_36%),radial-gradient(circle_at_bottom,rgba(255,255,255,0.05),transparent_28%)]" />
                ...
                {activeImage && baseSize.width > 0 && baseSize.height > 0 ? (
                  ...
                  >
                    ...
                    <img
                      ...
                      decoding="async"
                      fetchPriority="high"
                      className="pointer-events-none block h-full w-full select-none rounded-[1.2rem] object-contain shadow-[0_14px_30px_rgba(139,92,246,0.12)] sm:shadow-[0_22px_52px_rgba(139,92,246,0.16)]"
                      onLoad={(event) => {
              ...
              {images.length > 1 && (
                <>
                  <Button
                    ...
                    className="absolute left-3 top-1/2 h-11 w-11 -translate-y-1/2 rounded-full border border-white/10 bg-black/35 text-foreground/80 shadow-[0_10px_22px_rgba(139,92,246,0.15)] backdrop-blur hover:bg-white/10 hover:text-foreground disabled:opacity-35 sm:left-5"
                  ...
                  <Button
                    ...
                    onClick={goToNext}
                    disabled={!canGoNext}
                    className="absolute right-3 top-1/2 h-11 w-11 -translate-y-1/2 rounded-full border border-white/10 bg-black/35 text-foreground/80 shadow-[0_10px_22px_rgba(139,92,246,0.15)] backdrop-blur hover:bg-white/10 hover:text-foreground disabled:opacity-35 sm:right-5"
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "border-primary/70 shadow-[0_0_0_1px_rgba(139,92,246,0.35),0_10px_24px_rgba(139,92,246,0.2)]"
